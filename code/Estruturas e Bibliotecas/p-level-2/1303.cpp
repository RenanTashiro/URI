...
int compare( const void *first, const void *second )
{
    ...
    else if( ( 10000 * firstP.get / ( firstP.receive != 0 ? firstP.receive : 1 ) ) != ( 10000 * secondP.get / ( secondP.receive != 0 ? secondP.receive : 1 ) ) )
        return ( 10000 * secondP.get / ( secondP.receive != 0 ? secondP.receive : 1 ) ) - ( 10000 * firstP.get / ( firstP.receive != 0 ? firstP.receive : 1 ) );
